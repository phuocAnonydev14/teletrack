...
export const TopAnalysis = () => {
  ...
  return (
    <div
      className={cn(
        'flex h-full w-full flex-col items-center justify-center gap-x-1 gap-y-2 rounded-[8px] bg-analysisBg p-5 shadow-[100px_96px_39px_0px_rgba(160,213,232,0.00),64px_62px_36px_0px_rgba(160,213,232,0.01),36px_35px_30px_0px_rgba(160,213,232,0.05),16px_15px_22px_0px_rgba(160,213,232,0.09),4px_4px_12px_0px_rgba(160,213,232,0.10)] md:flex-row md:gap-4 lg:gap-9',
        resolvedTheme == 'light' &&
